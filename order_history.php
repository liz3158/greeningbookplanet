...
function getbookinfo($book_id, $orderid)
{
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
      ...
      $html .= '
      <tr>
      <td><a class="ps-product__preview" ><img class="mr-15" src="seller/img_book/' . $rows["img1"] . '" width="80" height="120" alt=""> ' . $rows["book_name"] . '</a></td>
      <td>
      ...
      <td>
        <a href="track_info.php?orderid=' . $orderid . '"><button class="ps-btn">Track<i class="ps-icon-next"></i></button></a>
          ...
          <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($rows = mysqli_fetch_assoc($result)) {
                ...
                if ($rows["admin_bank_in_status"] == "paid") {
