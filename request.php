...
//for login(identify who is login)
...
if (isset($_POST['submit'])) {
  ...
  $category_id = $_REQUEST['book_category'];
  ...
  //数据库指令（添加）
  $sql = "INSERT INTO request_list  VALUES (
        '$request_id'
        ,'$book_name'
        ,'$book_author'
        ,'$category_id' 
  ...
  if (mysqli_query($conn, $sql)) {
    ...
    echo "<script>alert('Your book reserved are successfully!');
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
            <div class="ps-section__header pt-50">
              <h2 class="ps-section__title" data-mask="The Request">- Your Request</h2><br><br>
              <div class="col">

                <p><strong>We appreciate when you search the collection before making a request. If you're new to searching the collection, we have tips that can help. Note that Bookshare may have alternate editions available in our library. We highly recommend using these alternate editions if possible as they are immediately available. <br><br>

                    If the book you need is not in the collection, fill out a book request form. Title and/or ISBN are required; it is helpful if you have author, publisher and copyright year as well. If we need additional information to fulfill your request, we'll contact you promptly.</strong></p>
              </div><br><br>
              <form class="ps-contact__form" action="request.php" method="post">
                ...
                <div class="form-group">
                  <label>Book Author <sub style="color: red;">*</sub></label>
                  <input class="form-control" type="text" placeholder="" name="book_author" id="book_author" required>
                </div>
                <div class="form-group">
                  <label>Book Category <sub style="color: red;">*</sub></label>
                  <input class="form-control" type="text" placeholder="" name="book_category" id="book_category" required>
                </div>
                <div class="form-group">
                  <label>Book Language <sub style="color: red;">*</sub></label>
                  <input class="form-control" type="text" placeholder="" name="book_language" id="book_language" required>
                </div>
                <div class="form-group">
                  <label>Book Description <sub style="color: red;">*</sub></label>
                  <textarea class="form-control" type="text" placeholder="" name="book_description" id="book_description" required></textarea>
                </div>
                <div class="form-group">
                  <button class="ps-btn" type="submit" name="submit" value="submit">Reserve Now<i class="ps-icon-next"></i></button>
                </div>
              </form>
            </div>
          </div>
