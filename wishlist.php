...
<script>
  ...
  $.get('getsession.php', function(data) {
    ...
    $.ajax({
      url: "wishlist_show.php",
      data: {
        option: "display_wishlist",
        user_id: user_id
      },
      cache: false,
      type: "POST",
      ...
      success: function(response) {
        ...
        var htmlwishlist = "";
        var html_wishlist_top = "";
        var html_wishlist_mid = "";
        var html_wishlist_bot = "";

        html_wishlist_top += '<div class="ps-content pt-80 pb-80">' +
          '<div class="ps-container">' +
        ...
        for (var x = 0; x < json.length; x++) {
          var wishlist_id = json[x].wishlist_id;
          ...
          html_wishlist_mid += '<tr>' +
            '<td>' + '<a class="ps-product__preview" href="product_detail.php?book_id=' + book_id + '">' + '<img class="mr-15" src="seller/img_book/' + img1 + '" alt="">' + '</a>' + '</td>' +
            ...
            '<td>' +
            '<a class="ps-remove" href="delete_wishlist.php?wishlist_id=' + wishlist_id + '">' + '</a>' +
            '</td>' +
            '</tr>';
        ...
        html_wishlist_bot += '</tbody>' +
          '</table>' +
          '</div>' +
          '</div>' +
          '</div>';

        htmlwishlist = html_wishlist_top + html_wishlist_mid + html_wishlist_bot;

        $("#here").html(htmlwishlist);
