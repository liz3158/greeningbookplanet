  ...
  <div class="ps-products-wrap inverse pt-80 pb-80">
    <div class="ps-products" data-mh="product-listing">
      <div class="ps-product__columns">
        <?php
        $result1 = mysqli_query($conn, "SELECT * FROM book WHERE subcategory_id='$subcategory_id'");
        $result2 = mysqli_query($conn, "SELECT * FROM book WHERE subcategory_id='$subcategory_id'");
        if (mysqli_fetch_array($result2) == 0) :; ?>
          <h1 align="center">No Result Have Been Found...<br>Wiil Be Coming Soon</h1>
        <?php endif;
        while ($row1 = mysqli_fetch_array($result1)) :; ?>
          <div class="ps-product__column">
            <div class="ps-shoe mb-30">
              <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="seller/img_book/<?php echo $row1[18]; ?>" alt=""><a class="ps-shoe__overlay" href="product_detail.php?book_id=<?php echo $row1[0]; ?>"></a>
              </div>
              <div class="ps-shoe__content">
                <div class="ps-shoe__variants">
                  <div class="ps-shoe__variant normal"><img src="seller/img_book/<?php echo $row1[18]; ?>" alt=""><img src="seller/img_book/<?php echo $row1[19]; ?>" alt=""><img src="seller/img_book/<?php echo $row1[20]; ?>" alt=""><img src="seller/img_book/<?php echo $row1[21]; ?>" alt=""></div>
                </div>
                <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product_detail.php?book_id=<?php echo $row1[0]; ?>"><?php echo $row1[4]; ?></a>
                  <p class="ps-shoe__categories"><?php echo $row1[4]; ?></p><del>RM<?php echo $row1[15]; ?></del> RM<?php echo $row1[14]; ?></span>
                </div>
              </div>
            </div>
          </div>
