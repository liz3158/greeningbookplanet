...
$result = mysqli_query($conn, "SELECT * FROM subcategory WHERE subcategory_id='$subcategory_id'");
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <div class="ps-section__header pt-0">
                    ...
                    <form class="ps-contact__form" action="update_sc.php" method="post">
                      <div class="form-group">
                        <label>Subcategory <sub style="color: red;">*</sub></label>
                        <input class="form-control" type="text" name="subcategory_name" value="<?php echo $data['subcategory_name'];  ?>" ></input>
                      </div>
                      <div class="form-group">
                      ...
                      <input type="hidden" value="<?php echo $subcategory_id?>" name="subcategory_id"></input>
                      ...
                      <div class="form-group">
                        ...
                        <a href="delete_sc.php?subcategory_id=<?php echo $subcategory_id ?>" class="btn btn-danger btn-icon-split">
                          <span class="icon text-white-50">
