                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Manage User DataTables</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="delete_user.php?user_id=<?php echo $row["user_id"]; ?>" onclick="return myConfirm();" class="btn btn-danger btn-icon-split">
